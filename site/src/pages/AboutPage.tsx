...
export function AboutPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-10 md:px-6 md:py-16">
      <div className="theme-panel rounded-[2rem] border p-8 shadow-2xl">
        <div className="font-mono text-xs uppercase tracking-[0.28em] text-cyan-300">About</div>
        <h1 className="theme-text-primary mt-3 font-display text-4xl font-bold">Repository-first documentation</h1>
